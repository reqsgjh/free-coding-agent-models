...
**Honest headline (2026-08-29):** almost no hosted API is truly unlimited. Most “free unlimited” claims hide RPM/RPD caps, weekly quotas, or rotating model IDs. The only reliably unlimited path is **local inference** (Ollama, LM Studio, llama.cpp).
...
| Provider | What they say | Practical limit (as of 2026-08-29) | Card? | Coding / agents |
| --- | --- | --- | --- | --- |
...
Pulled from `GET https://openrouter.ai/api/v1/models` with `pricing.prompt == 0` and `pricing.completion == 0` on 2026-08-30 04:08 UTC.
